...
(custom-set-variables
 ...
 '(org-structure-template-alist
   '(("q" . "quote")
     ...
     ("es" . "src emacs-lisp :results output silent")
     ("a" . "export ascii")
     ("c" . "center")
     ("C" . "comment")
     ("e" . "example")
