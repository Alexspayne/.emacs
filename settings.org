...
- ~C-c RET~ — send the current prompt (works in any buffer with a region selected too)
- ~C-c C-l~ — quick rewrite/refactor selected region with Claude
